...
from lol_review.report import generate_report
from lol_review.riot_client import RiotClient

# packages/lol_review/src/lol_review/cli.py -> packages/lol_review/
_PACKAGE_ROOT = Path(__file__).parent.parent.parent
_ENV_PATH = _PACKAGE_ROOT.parent.parent / ".env"  # repo root .env
...
def set_api_key() -> None:
    ...
    click.echo("API キーを .env に保存しました。")
